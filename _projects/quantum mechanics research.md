...
<p> 
Now let us define the inner product. An inner product is a number given by $$(\dot,\dot)$$ for two vectors "$$\dot$$". An inner product is linear in the second argument, or
</p>
