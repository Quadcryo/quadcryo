...
Now let us define the inner product. An inner product is a number given by $$(\cdot,\cdot)$$ for two vectors "$$\cdot$$". An inner product is linear in the second argument, 
<br>
